...
public class VillagePointInVillageSelection : MonoBehaviour, IDataPersistence
{
    public VillageInVillageSelectionData villageData;
    ...
    {
        var level = data.enemyVillages.Find(level => level.data == villageData);
        if (level != null)
        {
