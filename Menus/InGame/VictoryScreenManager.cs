...
public class VictoryScreenManager : MonoBehaviour
{
    ...
    [SerializeField] private DynamicAddingTextEffect xpAmountTextEffect;
    [SerializeField] private DynamicAddingTextEffect killAmountTextEffect;
    ...
    public void StartXpAmountTextEffect()
    {
        xpAmountTextEffect.SetNumber(XPManager.Instance.Xp);
    }

    public void StartKillAmountTextEffect()
    {
        killAmountTextEffect.SetNumber(EnemyCounterManager.Instance.killCount);
    }
